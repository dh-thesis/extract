...
log = open(LOG_DIR + "graph_sel_ous_mpis.log", "w+")
sys.stdout = log
...
utils.write_csv(GRAPH_DIR + "sel--ous_nodes--tree.csv",ous_nodes)
utils.write_csv(GRAPH_DIR + "sel--ous_ous_edges.csv",ous_edges)
...
utils.write_csv(GRAPH_DIR + 'sel--ous_nodes.csv', institutes)

## Children of Institutes

kids_names = [["Id","Label"]]

mpis_kids_nodes = utils.read_csv_with_header(GRAPH_DIR + 'sel--ous_nodes--tree.csv')
...
utils.write_csv(GRAPH_DIR + 'sel--ous_nodes--children.csv', kids_names)
